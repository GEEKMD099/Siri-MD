...
Secktor.cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (text.split(" ")[0]) {
                ...
                let str = `✶━━┉┉┉┉┉━╾╾━┉┉┉┉┉━━✶` + fancytext(Config.ownername.split(' ')[0], 58) +` ✶━━┉┉┉┉┉━╾╾━┉┉┉┉┉━━✶n\ 𝑆𝛪𝑅𝛪-𝛭𝐷-𝐵𝛩𝑇\n✶━━┉┉┉┉┉━╾╾━┉┉┉┉┉━━✶\n🅼⃝⃝⃝⃞🅴⃞🅽⃞🆄⃞🅻⃞🅸⃞🆂⃞🆃⃞\n✶━━┉┉┉┉┉━╾╾━┉┉┉┉┉━━✶\n`
                str +=
                    '```' + `┏┉┉┉┉┉┉┉┉━┉┉┉┉┉┉┉┉⃥
┊╭═══════╍════════⃥
┋┊➣𝚩𝚯𝚻 𝚴𝚫𝚳𝚵 :- 𝑆𝛪𝑅𝛪 𝛭𝐷 
...
┋┊➣𝚻𝚮𝚵𝚳𝚵 :- ${tlang().title}
┊┋➣𝚸𝚪𝚵𝐅𝚰𝚾 :- [ ${prefix} ]
┋┊➣𝚯𝐖𝚴𝚵𝚪 :- ${Config.ownername}
┊┋➣𝐃𝚵𝛁𝚵𝐋𝚯𝚸𝚵𝚪 :- ᴍʀ.ʜᴀɴꜱᴀᴍᴀʟᴀ
┋┊➣𝚸𝐋𝐔𝐆𝚰𝚴𝐒 :- ${commands.length}
┋┊➣𝚸𝐋𝐔𝐆𝚰𝚴𝐒 :- ${total}
┊┋➣𝐔𝚸𝚻𝚰𝚳𝚵 :- ${runtime(process.uptime())}
┋┊➣𝚳𝚵𝚳𝚯𝚪𝐘 :- ${formatp(os.totalmem() - os.freemem())}/${formatp(os.totalmem())}
┊┋➣𝚻𝚰𝚳𝚵 :- ${time}
┋┊➣𝐃𝚫𝚻𝚵 :- ${date}
│ ┖┈─┈──┈─◈❁◈─┈─┈─┈─◍
┗┉┉┉┉┉┉┉┉━┉┉┉┉┉┉┉┉⃥\n
